...
PROJECT_NAME ?= provider-dynatrace-iam
...
export TERRAFORM_PROVIDER_VERSION ?= 1.102.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-dynatrace_v$(TERRAFORM_PROVIDER_VERSION)
